    ...
    <div class="container">
        <div class="row py-2 col-lg-12 mx-auto py-3">
            ...
            <div class="col-lg-6 text-center">
                <img src="./images/Rectangle 29 (1).png" class="img-fluid" alt="">
            </div>
            ...
            <div class="caseStudy">
                ...
                <div class="p-3">
                    <div class="row gx-3">
                        <div class="col-lg-6 text-center">
                            <img src="images/Case Picture (1).png" class="img-fluid rounded-3 mx-auto" alt="">
                        </div>
                        <div class="col-lg-6">
                            <div class="theme-b bg-primary rounded-4 p-3">
                                <h3 class="poppins-bold text-light">Navigating Complex Compliance and Achieving..</h3>
            ...
            <div class="col-lg-12 text-center mt-5"> 
                ...
                <a href="./contact.php" class="btn bg-primary py-2 px-5 poppins-bold text-white">Contact Us Today</a>
